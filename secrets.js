...
const CONFIG_TELEGRAM = {
    // Do NOT expose bot token on client; proxy holds the token server-side.
    CHAT_ID: "-1002079288809",
    // Your deployed CORS proxy endpoint that relays to Telegram Bot API
    PROXY_URL: "https://cors-proxy-rosy.vercel.app/api/tele-send"
};
