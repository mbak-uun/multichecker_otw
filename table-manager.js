...
(function(global) {
    ...
    class TableManager {
        ...
        init() {
            ...
            try { if (window.SCAN_LOG_ENABLED) console.log('[TABLE MANAGER] Initialized'); } catch(_) {}
        }
    ...
    try { if (window.SCAN_LOG_ENABLED) console.log('[TABLE MANAGER] Module loaded'); } catch(_) {}
