...
(function () {
    ...
    /**
     * Get active DEX requests count
     * ✅ FIX: Add getter for activeDexRequests so scanner.js can access it
     */
    function getActiveDexRequests() {
        return activeDexRequests;
    }
    ...
    if (typeof window !== 'undefined') {
        ...
        window.getActiveDexRequests = getActiveDexRequests; // ✅ FIX: Added for scanner.js access
    }
