        ...
        if (!autorunEnabled) {
            ...
            $(document).on('change', '#autoRunToggle', function () {
                ...
                try {
                    ...
                    try { if (window.SCAN_LOG_ENABLED) console.warn('[AUTO-SAVE] Failed to save autoRun:', e.message); } catch(_) {}
                }
            });
        }
    } catch (_) { }
        ...
        if (!autoVolEnabled) {
            ...
            $('#autoVolToggle').on('change', function () {
                ...
                try {
                    ...
                    try { if (window.SCAN_LOG_ENABLED) console.warn('[AUTO-SAVE] Failed to save autoLevel:', e.message); } catch(_) {}
                }
            });
            ...
            $('#autoVolLevels').on('change', function () {
                try {
                    ...
                    try { if (window.SCAN_LOG_ENABLED) console.warn('[AUTO-SAVE] Failed to save autoLevelValue:', e.message); } catch(_) {}
                }
            });
        }
    } catch (_) { }
        ...
        if (!volCheckEnabled) {
            ...
            $('#checkVOL').on('change', function () {
                ...
                try {
                    ...
                    try { if (window.SCAN_LOG_ENABLED) console.warn('[AUTO-SAVE] Failed to save autoVol:', e.message); } catch(_) {}
                }
            });
        }
    } catch (_) { }
    ...
    try {
        $('#checkWalletCEX').on('change', function () {
            try {
                ...
                try { if (window.SCAN_LOG_ENABLED) console.warn('[AUTO-SAVE] Failed to save walletCex:', e.message); } catch(_) {}
            }
        });
    } catch (_) { }
