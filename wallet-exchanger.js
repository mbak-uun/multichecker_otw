...
(function initWalletExchangerUI(global) {
    ...
    function showUpdateResult(success, failedCexes) {
        ...
        try {
            ...
            try { if (window.SCAN_LOG_ENABLED) console.warn('[Wallet Exchanger] Failed to save report to localStorage:', e); } catch(_) {}
        }
    ...
    function restoreSavedReport() {
        try {
            ...
            try { if (window.SCAN_LOG_ENABLED) console.warn('[Wallet Exchanger] Failed to restore report:', e); } catch(_) {}
        }
    }
    ...
    function hideFetchProgressOverlay() {
        ...
        }, 5000); // ✅ UBAH: 1000ms → 5000ms (5 detik) agar user punya waktu membaca hasil
    }
