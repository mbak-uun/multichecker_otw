...
(function(global) {
    ...
    class EventBus {
        constructor() {
            ...
            try { if (window.SCAN_LOG_ENABLED) console.log('[EVENT BUS] Initialized'); } catch(_) {}
        }
        ...
        on(event, callback, options = {}) {
            ...
            if (this.debugMode) {
                try { if (window.SCAN_LOG_ENABLED) console.log(`[EVENT BUS] Registered listener for "${event}" (${listener.id})`); } catch(_) {}
            }
        ...
        off(event, callbackOrId) {
            ...
            if (this.debugMode) {
                try { if (window.SCAN_LOG_ENABLED) console.log(`[EVENT BUS] Removed listener for "${event}"`); } catch(_) {}
            }
        }
        ...
        emit(event, data = {}) {
            ...
            if (this.debugMode) {
                try { if (window.SCAN_LOG_ENABLED) console.log(`[EVENT BUS] Emitting "${event}"`, data); } catch(_) {}
            }

            if (!this.listeners.has(event)) {
                if (this.debugMode) {
                    try { if (window.SCAN_LOG_ENABLED) console.log(`[EVENT BUS] No listeners for "${event}"`); } catch(_) {}
                }
                return;
            }
        ...
        clearAll() {
            this.listeners.clear();
            if (this.debugMode) {
                try { if (window.SCAN_LOG_ENABLED) console.log('[EVENT BUS] Cleared all listeners'); } catch(_) {}
            }
        }
        ...
        enableDebug() {
            this.debugMode = true;
            try { if (window.SCAN_LOG_ENABLED) console.log('[EVENT BUS] Debug mode enabled'); } catch(_) {}
        }
        ...
        disableDebug() {
            this.debugMode = false;
            try { if (window.SCAN_LOG_ENABLED) console.log('[EVENT BUS] Debug mode disabled'); } catch(_) {}
        }
        ...
        printStats() {
            ...
            try { if (window.SCAN_LOG_ENABLED) console.log('[EVENT BUS] Statistics:', stats); } catch(_) {}
            return stats;
        }
    }
    ...
    try { if (window.SCAN_LOG_ENABLED) console.log('[EVENT BUS] Module loaded'); } catch(_) {}
